...
import WhiteBoard from './components/board/WhiteBoard.vue'
import Board from './components/board/Board.vue'
import AnimeList from './components/anime/AnimeList.vue'
import Default from './layouts/Default.vue'
// import QuizComponent from './components/quizapi/QuizComponent.vue'
import { ref } from 'vue'
...
<template>
  ...
  <br>
  <br>
  <div class="bg-gray-100 text-red-500">Tailwind 動いてる？</div>
  <div class="bg-gray-500 text-white text-center p-4">
